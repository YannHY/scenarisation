...
<main class="legal-shell">
    <article class="legal-card">
        ...
        <ul>
            ...
            <li>Cloudflare Turnstile pour la vérification anti-robot des formulaires de compte concernés&nbsp;;</li>
        ...
        <ul>
            <li><strong>Compte et scénarios enregistrés&nbsp;:</strong> jusqu’à la suppression du scénario ou du compte par son titulaire, ou par un administrateur habilité lorsque la gestion du service l’exige. La suppression du compte entraîne celle des scénarios et des jetons CLI associés.</li>
            ...
            <li><strong>Scénario public&nbsp;:</strong> jusqu’à sa dépublication, son retrait du catalogue ou la suppression du scénario ou du compte.</li>
            <li><strong>Compteurs anti-abus des comptes&nbsp;:</strong> validité de 15 minutes à une heure ; suppression à la prochaine tentative protégée suivant leur expiration.</li>
