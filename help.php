    ...
    <div class="help-layout">
        ...
        <div class="help-content">
                ...
                <div class="help-table-wrap">
                    <table class="help-table">
                        ...
                        <tbody>
                            ...
                            <tr><td>Compétences</td><td>Une ou plusieurs compétences issues de huit cadres</td><td>Relie l’activité à Florimont, au Socle commun, à GreenComp, à DigComp, au CRCN, à Pix, à Pix IA ou au PER romand.</td></tr>
                        </tbody>
                    </table>
                </div>
            ...
            <article class="help-section" id="acquis-competences">
                ...
                <p>Dans chaque activité, le bouton <strong>Sélectionner des compétences</strong> permet d’abord de choisir un cadre, puis un domaine et une ou plusieurs compétences. Huit cadres sont disponibles : Florimont, le Socle commun, GreenComp, DigComp 3.0, le CRCN, Pix, Pix IA et le PER romand.</p>
                <div class="help-grid three">
                    ...
                    <div class="help-card"><strong><span class="help-card-icon"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i></span>CRCN</strong><span>16 compétences du cadre français, détaillées en 162 repères sélectionnables des niveaux 1 à 5.</span></div>
                ...
                <p class="help-spaced">Les 169 repères GreenComp précisent les compétences de ce cadre sans être comptés comme des compétences supplémentaires. Dans DigComp 3.0, chacun des 362 énoncés codés CS peut en revanche être sélectionné individuellement, comme une compétence Florimont. Le texte anglais officiel est conservé et une traduction française propre à l’application est proposée ; la Commission européenne n’est pas responsable de cette traduction. Pix et Pix IA sont deux référentiels complémentaires : le second ne remplace pas le référentiel Pix général. La page <a href="competencies.php">Référentiels de compétences</a> permet de consulter les huit catalogues complets, de les filtrer, de les rechercher et d’ouvrir leur source de référence.</p>
                <p data-i18n-fr="Le CRCN reprend le document détaillé d’Éduscol : définitions et repères par niveau. Les textes officiels restent en français dans les deux langues de l’interface. Les codes des repères (par exemple 1.1.N2.1) sont propres à l’application. Le document ne fournit pas de repère de niveau 1 pour la compétence 4.1." data-i18n-en="CRCN follows the detailed Eduscol document: definitions and indicators by level. Official texts remain in French in both interface languages. Indicator codes (such as 1.1.N2.1) are application-specific. The document provides no level 1 indicator for competency 4.1.">Le CRCN reprend le document détaillé d’Éduscol : définitions et repères par niveau. Les textes officiels restent en français dans les deux langues de l’interface. Les codes des repères (par exemple 1.1.N2.1) sont propres à l’application. Le document ne fournit pas de repère de niveau 1 pour la compétence 4.1.</p>
                <p data-i18n-fr="Le PER romand couvre les neuf objectifs d’Éducation numérique des cycles 1 (1re–4e), 2 (5e–8e) et 3 (9e–11e), dans les axes médias, science informatique et usages. Les intitulés officiels, les 47 composantes, les 134 entrées de progression et les 46 attentes fondamentales sont conservés en français, y compris dans l’interface anglaise. Les rubriques, les années et les indications pédagogiques associées sont précisées. Les suffixes des codes sont des identifiants de l’application ; les liens Source renvoient au PER." data-i18n-en="PER romand covers all nine Digital Education objectives across cycles 1 (years 1–4), 2 (years 5–8) and 3 (years 9–11), in media, computer science and uses. Official titles, 47 components, 134 learning-progression entries and 46 fundamental expectations are preserved in French, including in the English interface. Sections, school years and associated teaching guidance are included. Code suffixes are application identifiers; Source links lead to the PER.">Le PER romand couvre les neuf objectifs d’Éducation numérique des cycles 1 (1re–4e), 2 (5e–8e) et 3 (9e–11e), dans les axes médias, science informatique et usages. Les intitulés officiels, les 47 composantes, les 134 entrées de progression et les 46 attentes fondamentales sont conservés en français, y compris dans l’interface anglaise. Les rubriques, les années et les indications pédagogiques associées sont précisées. Les suffixes des codes sont des identifiants de l’application ; les liens Source renvoient au PER.</p>
