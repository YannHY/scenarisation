...
const SCHOOL_SYSTEM_OPTIONS = [
  ...
  { value: "ib", labels: { fr: "International Baccalaureate (IB)", en: "International Baccalaureate (IB)" } },
...
const SCHOOL_LEVEL_OPTIONS = {
  ...
  ib: [
    { value: "ib_pyp", labels: { fr: "PYP — Primary Years Programme (ages 3–12)", en: "PYP — Primary Years Programme (ages 3–12)" }, aliases: ["PP", "PYP", "Programme primaire", "Primary Years Programme", "PP — Programme primaire (3–12 ans)"] },
    { value: "ib_myp_1", labels: { fr: "MYP — Middle Years Programme — year 1", en: "MYP — Middle Years Programme — year 1" }, aliases: ["PEI 1", "MYP 1", "MYP1", "PEI — Programme d’éducation intermédiaire — 1re année"] },
    { value: "ib_myp_2", labels: { fr: "MYP — Middle Years Programme — year 2", en: "MYP — Middle Years Programme — year 2" }, aliases: ["PEI 2", "MYP 2", "MYP2", "PEI — Programme d’éducation intermédiaire — 2e année"] },
    { value: "ib_myp_3", labels: { fr: "MYP — Middle Years Programme — year 3", en: "MYP — Middle Years Programme — year 3" }, aliases: ["PEI 3", "MYP 3", "MYP3", "PEI — Programme d’éducation intermédiaire — 3e année"] },
    { value: "ib_myp_4", labels: { fr: "MYP — Middle Years Programme — year 4", en: "MYP — Middle Years Programme — year 4" }, aliases: ["PEI 4", "MYP 4", "MYP4", "PEI — Programme d’éducation intermédiaire — 4e année"] },
    { value: "ib_myp_5", labels: { fr: "MYP — Middle Years Programme — year 5", en: "MYP — Middle Years Programme — year 5" }, aliases: ["PEI 5", "MYP 5", "MYP5", "PEI — Programme d’éducation intermédiaire — 5e année"] },
    { value: "ib_dp_1", labels: { fr: "DP — Diploma Programme — year 1", en: "DP — Diploma Programme — year 1" }, aliases: ["Diplôme 1", "DP 1", "DP1", "Diplôme — Programme du diplôme — 1re année"] },
    { value: "ib_dp_2", labels: { fr: "DP — Diploma Programme — year 2", en: "DP — Diploma Programme — year 2" }, aliases: ["Diplôme 2", "DP 2", "DP2", "Diplôme — Programme du diplôme — 2e année"] },
    { value: "ib_cp_1", labels: { fr: "CP — Career-related Programme — year 1", en: "CP — Career-related Programme — year 1" }, aliases: ["POP 1", "CP 1", "CP1", "POP — Programme à orientation professionnelle — 1re année"] },
    { value: "ib_cp_2", labels: { fr: "CP — Career-related Programme — year 2", en: "CP — Career-related Programme — year 2" }, aliases: ["POP 2", "CP 2", "CP2", "POP — Programme à orientation professionnelle — 2e année"] },
  ],
  isced_2011: [
...
const I18N = {
  fr: {
    ...
    info: "Information",
    toolbarRegion: "Actions du scénario",
    analysisTitle: "Expérience d’apprentissage",
    analysisTooltip: "Synthèse visuelle de la répartition de la durée conçue selon les choix pédagogiques",
    analysisAiasTitle: "AIAS · Répartition pondérée par la durée",
    analysisAiasTooltip: "Répartition de la durée conçue selon le niveau d'usage de l'IA autorisé pour les activités",
    metaNameLabel: "Titre",
    metaNameTooltip: "Nom donné au scénario pédagogique",
    metaLearningLabel: "Durée prévue",
    metaLearningTooltip: "Durée totale prévue pour le scénario, à renseigner en jours, heures et minutes",
    metaDesignedLabel: "Durée conçue",
    metaDesignedTooltip: "Durée totale calculée automatiquement à partir de la somme des durées des activités",
    metaDayLabel: "1 jour =",
    ...
    outcomesDescription: "Les acquis d’apprentissage décrivent ce que les apprenants seront capables de faire à l’issue de la formation. Formulez des résultats observables ; la taxonomie de Bloom peut vous aider à choisir des verbes d’action.",
    outcomesFreePlaceholder: "À l’issue de la formation, les apprenants seront capables de…",
    ...
    addOutcome: "Ajouter un acquis d’apprentissage",
    editOutcome: "Modifier l’acquis",
    removeBloomTag: "Retirer le tag Bloom",
    ...
    bloomSubtitle: "Un seul tag facultatif par acquis : choisissez un niveau ou un verbe d’action. Un nouveau choix remplace le précédent.",
    bloomSelectLevel: "Choisir ce niveau",
    bloomAdd: "Ajouter",
    bloomEdit: "Modifier",
    unitDays: "jours",
    unitHours: "heures",
    ...
    importModalDesc: "Partez d’un modèle prérempli, ou chargez un fichier exporté depuis cette application. Le scénario actuel sera remplacé.",
    ...
    exportTitle: "Exporter le scénario",
    ...
    analysisLearningTooltip: "Répartition de la durée conçue entre les six types d'apprentissage",
    groupTitleGroup: "Groupe",
    analysisGroupTooltip: "Répartition de la durée conçue entre travail individuel, en sous-groupes et en groupe entier",
    groupTitleTeaching: "Enseignement",
    analysisTeachingTooltip: "Répartition de la durée conçue entre enseignement dirigé, guidé, accompagné et autonome",
    groupTitlePacing: "Rythme",
    analysisPacingTooltip: "Répartition de la durée conçue entre activités synchrones et asynchrones",
    groupTitleMode: "Modalité",
    analysisDeliveryTooltip: "Répartition de la durée conçue selon le lieu et la modalité de réalisation des activités",
    groupTitleEvaluation: "Évaluation",
    analysisEvaluationTooltip: "Répartition de la durée conçue selon le type d'évaluation prévu",
    ...
    newDesignConfirm: "Créer un nouveau scénario et écraser le contenu actuel ?",
    newDesignModalTitle: "Nouveau scénario",
    newDesignModalMsg: "Vous allez créer un nouveau scénario vierge. Si vous n'avez pas enregistré le scénario actuel, il sera perdu.",
    newDesignModalConfirm: "Créer un nouveau scénario",
    ...
    an07: "La durée conçue dépasse la durée prévue.",
    an08: "La durée prévue n’est pas définie, mais des activités ont une durée.",
    ...
    infoP5: "Le sélecteur propose huit cadres : Florimont, Socle commun, GreenComp, DigComp, CRCN, Pix, Pix IA et le PER romand.",
    noData: "Aucune donnée",
    learningDaysLabel: "Jours prévus",
    learningHoursLabel: "Heures prévues",
    learningMinutesLabel: "Minutes prévues",
    ...
    partitionTypeLocation: "Modalité",
  ...
  en: {
    ...
    info: "About",
    toolbarRegion: "Scenario actions",
    ...
    outcomesDescription: "Learning outcomes describe what learners will be able to do by the end of the course. Write observable results; Bloom’s taxonomy can help you choose action verbs.",
    outcomesFreePlaceholder: "By the end of the course, learners will be able to…",
    outcomesTooltip: "What learners should know, understand or be able to do after the course. This section is optional.",
    addOutcome: "Add a learning outcome",
    editOutcome: "Edit outcome",
    removeBloomTag: "Remove Bloom tag",
    ...
    bloomSubtitle: "One optional tag per outcome: choose a level or an action verb. A new choice replaces the previous one.",
    bloomSelectLevel: "Choose this level",
    bloomAdd: "Add",
    bloomEdit: "Update",
    unitDays: "days",
    unitHours: "hours",
    ...
    importModalDesc: "Start from a pre-filled template, or load a file exported from this application. The current scenario will be replaced.",
    ...
    exportTitle: "Export scenario",
    exportScopeTitle: "Content to export",
    exportScopeFull: "Full export",
    exportScopeFullDescription: "All the information in the learning scenario.",
    ...
    newDesignConfirm: "Create a new scenario and replace current content?",
    newDesignModalTitle: "New scenario",
    newDesignModalMsg: "You are about to create a blank new scenario. If you have not saved the current scenario, it will be lost.",
    newDesignModalConfirm: "Create a new scenario",
    ...
    infoTitle: "About",
    footerHelp: "Help",
    footerSharedDesigns: "Shared scenarios",
    infoP1: "This single-page web app is inspired by the UCL Learning Designer:",
    infoP2: "(UCL Knowledge Lab, UCL Institute of Education, 2013-2026).",
    infoP3: "Local processing by default: data stays in your browser unless you sign in and explicitly save a scenario to your account.",
    ...
    infoP5: "The picker includes eight frameworks: Florimont, the French common core, GreenComp, DigComp, CRCN, Pix, Pix AI, and PER romand.",
    noData: "No data",
