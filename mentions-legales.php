...
<main class="legal-shell">
    <article class="legal-card">
        ...
        <p>Le formulaire d’avis est destiné aux retours sincères portant sur l’utilisation et l’amélioration de Scénarisation. Il ne doit pas être utilisé pour transmettre des contenus illicites, injurieux, publicitaires, automatisés, ni des données personnelles ou confidentielles concernant l’utilisateur ou un tiers.</p>
